...
use super::{AesGcm256, AesGcmSealedBox, CryptoError, EncryptionKey, PbHkdfSha256, Result, Salt};
...
mod tests {
    ...
    fn test_decrypt_invalid_utf8() {
        ...
        assert!(matches!(result, Err(CryptoError::InvalidUtf8)));
    }
}
